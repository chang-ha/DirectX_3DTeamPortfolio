...
void Monster_Hollow::Start()
{
	...
	BodyCollision = CreateSocketCollision(Enum_CollisionOrder::Monster_Body, static_cast<int>(Enum_Hollow_BoneType::Spine), { float4(100.0f, 100.0f, 100.0f), float4::ZERONULL, float4::ZERO }, "Spine");
