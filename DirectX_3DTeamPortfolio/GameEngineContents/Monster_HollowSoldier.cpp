...
void Monster_HollowSoldier::Start()
{
	CommonMonster::Start();
	{
		...
		MainRenderer->SetFBXMesh("c1100.FBX", "FBXAnimationTexture"); // Bone 136
	...
	//FBXRenderer->RenderUnits[6][0]->Off();
	//FBXRenderer->RenderUnits[7][0]->Off();
	//FBXRenderer->RenderUnits[8][0]->Off();
	//FBXRenderer->RenderUnits[20][0]->Off();
}
