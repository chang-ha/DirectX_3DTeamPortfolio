...
void Monster_Hollow::SettingRootMotion()
{
	...
	MainRenderer->SetRootMotionMoveRatio("c1100_Walk_Front", 3.0f, 3.0f, 3.0f);
	MainRenderer->SetRootMotion("c1100_Walk_Back");
	MainRenderer->SetRootMotionMoveRatio("c1100_Walk_Back", 3.0f, 3.0f, 3.0f);
	MainRenderer->SetRootMotion("c1100_Walk_Left");
	MainRenderer->SetRootMotionMoveRatio("c1100_Walk_Left", 3.0f, 3.0f, 3.0f);
	MainRenderer->SetRootMotion("c1100_Walk_Right");
	MainRenderer->SetRootMotionMoveRatio("c1100_Walk_Right", 3.0f, 3.0f, 3.0f);
	MainRenderer->SetRootMotion("c1100_Walk_Front3");
	MainRenderer->SetRootMotionMoveRatio("c1100_Walk_Front3", 3.0f, 3.0f, 3.0f);
	MainRenderer->SetRootMotion("c1100_Walk_Back3");
	MainRenderer->SetRootMotionMoveRatio("c1100_Walk_Back3", 3.0f, 3.0f, 3.0f);
	MainRenderer->SetRootMotion("c1100_Walk_Left3");
	MainRenderer->SetRootMotionMoveRatio("c1100_Walk_Left3", 3.0f, 3.0f, 3.0f);
	MainRenderer->SetRootMotion("c1100_Walk_Right3");
	MainRenderer->SetRootMotionMoveRatio("c1100_Walk_Right3", 3.0f, 3.0f, 3.0f);
	MainRenderer->SetRootMotion("c1100_Run");
	MainRenderer->SetRootMotionMoveRatio("c1100_Run", 1.5f, 1.5f, 1.5f);
	MainRenderer->SetRootMotion("c1100_Run3");
	MainRenderer->SetRootMotionMoveRatio("c1100_Run3", 1.5f, 1.5f, 1.5f);
	...
	MainRenderer->SetRootMotionMoveRatio("c1100_RH_VerticalSlash", 1.5f, 1.5f, 1.5f);
	MainRenderer->SetRootMotion("c1100_RH_HorizontalSlash");
	MainRenderer->SetRootMotionMoveRatio("c1100_RH_HorizontalSlash", 1.5f, 1.5f, 1.5f);
	MainRenderer->SetRootMotion("c1100_RH_ChargingSting");
	MainRenderer->SetRootMotionMoveRatio("c1100_RH_ChargingSting", 1.5f, 1.5f, 1.5f);
	MainRenderer->SetRootMotion("c1100_RH_RunToSting");
	MainRenderer->SetRootMotionMoveRatio("c1100_RH_RunToSting", 1.5f, 1.5f, 1.5f);
	MainRenderer->SetRootMotion("c1100_LH_Fist");
	MainRenderer->SetRootMotionMoveRatio("c1100_LH_Fist", 1.5f, 1.5f, 1.5f);
	MainRenderer->SetRootMotion("c1100_TH_VerticalSlash");
	MainRenderer->SetRootMotionMoveRatio("c1100_TH_VerticalSlash", 1.5f, 1.5f, 1.5f);
	MainRenderer->SetRootMotion("c1100_RH_ComboAttack");
	MainRenderer->SetRootMotionMoveRatio("c1100_RH_ComboAttack", 1.5f, 1.5f, 1.5f);
	//MainRenderer->SetRootMotion("c1100_RH_ChargingSlash");
	MainRenderer->SetRootMotion("c1100_RH_Sting");
	MainRenderer->SetRootMotionMoveRatio("c1100_RH_Sting", 1.5f, 1.5f, 1.5f);
	MainRenderer->SetRootMotion("c1100_RH_TwinSlash");
	MainRenderer->SetRootMotionMoveRatio("c1100_RH_TwinSlash", 1.5f, 1.5f, 1.5f);
	...
	MainRenderer->SetRootMotionMoveRatio("c1100_HitToDeath", 1.5f, 1.5f, 1.5f);
	...
	MainRenderer->SetRootMotionMoveRatio("c1100_Spear_Walk_Front2", 3.0f, 3.0f, 3.0f);
	MainRenderer->SetRootMotion("c1100_Spear_Walk_Back2");
	MainRenderer->SetRootMotionMoveRatio("c1100_Spear_Walk_Back2", 3.0f, 3.0f, 3.0f);
	MainRenderer->SetRootMotion("c1100_Spear_Walk_Left2");
	MainRenderer->SetRootMotionMoveRatio("c1100_Spear_Walk_Left2", 3.0f, 3.0f, 3.0f);
	MainRenderer->SetRootMotion("c1100_Spear_Walk_Right2");
	MainRenderer->SetRootMotionMoveRatio("c1100_Spear_Walk_Right2", 3.0f, 3.0f, 3.0f);
	MainRenderer->SetRootMotion("c1100_Spear_Walk_Front3");
	MainRenderer->SetRootMotionMoveRatio("c1100_Spear_Walk_Front3", 3.0f, 3.0f, 3.0f);
	MainRenderer->SetRootMotion("c1100_Spear_Walk_Back3");
	MainRenderer->SetRootMotionMoveRatio("c1100_Spear_Walk_Back3", 3.0f, 3.0f, 3.0f);
	MainRenderer->SetRootMotion("c1100_Spear_Walk_Left3");
	MainRenderer->SetRootMotionMoveRatio("c1100_Spear_Walk_Left3", 3.0f, 3.0f, 3.0f);
	MainRenderer->SetRootMotion("c1100_Spear_Walk_Right3");
	MainRenderer->SetRootMotionMoveRatio("c1100_Spear_Walk_Right3", 3.0f, 3.0f, 3.0f);
	MainRenderer->SetRootMotion("c1100_Spear_Run2");
	MainRenderer->SetRootMotionMoveRatio("c1100_Spear_Run2", 1.5f, 1.5f, 1.5f);
	MainRenderer->SetRootMotion("c1100_Spear_Run3");
	MainRenderer->SetRootMotionMoveRatio("c1100_Spear_Run3", 1.5f, 1.5f, 1.5f);
	...
	MainRenderer->SetRootMotionMoveRatio("c1100_Spear_Pike1", 1.5f, 1.5f, 1.5f);
	MainRenderer->SetRootMotion("c1100_Spear_Pike2");
	MainRenderer->SetRootMotionMoveRatio("c1100_Spear_Pike2", 1.5f, 1.5f, 1.5f);
	MainRenderer->SetRootMotion("c1100_Spear_StepAndPike");
	MainRenderer->SetRootMotionMoveRatio("c1100_Spear_StepAndPike", 1.5f, 1.5f, 1.5f);
	MainRenderer->SetRootMotion("c1100_Spear_Swing");
	MainRenderer->SetRootMotionMoveRatio("c1100_Spear_Swing", 1.5f, 1.5f, 1.5f);
	MainRenderer->SetRootMotion("c1100_Spear_RunToPike");
	MainRenderer->SetRootMotionMoveRatio("c1100_Spear_RunToPike", 1.5f, 1.5f, 1.5f);
	MainRenderer->SetRootMotion("c1100_Spear_ShieldCharge");
	MainRenderer->SetRootMotionMoveRatio("c1100_Spear_ShieldCharge", 1.5f, 1.5f, 1.5f);
	MainRenderer->SetRootMotion("c1100_Spear_TriplePike");
	MainRenderer->SetRootMotionMoveRatio("c1100_Spear_TriplePike", 1.5f, 1.5f, 1.5f);
	...
	MainRenderer->SetRootMotionMoveRatio("c1100_BrokenSword_RH_VerticalSlash", 1.5f, 1.5f, 1.5f);
	MainRenderer->SetRootMotion("c1100_BrokenSword_RH_HorizontalSlash");
	MainRenderer->SetRootMotionMoveRatio("c1100_BrokenSword_RH_HorizontalSlash", 1.5f, 1.5f, 1.5f);
	MainRenderer->SetRootMotion("c1100_BrokenSword_TH_VerticalSlash");
	MainRenderer->SetRootMotionMoveRatio("c1100_BrokenSword_TH_VerticalSlash", 1.5f, 1.5f, 1.5f);
	MainRenderer->SetRootMotion("c1100_BrokenSword_RH_ComboAttack");
	MainRenderer->SetRootMotionMoveRatio("c1100_BrokenSword_RH_ComboAttack", 1.5f, 1.5f, 1.5f);
	MainRenderer->SetRootMotion("c1100_BrokenSword_RH_RunToSlash");
	MainRenderer->SetRootMotionMoveRatio("c1100_BrokenSword_RH_RunToSlash", 1.5f, 1.5f, 1.5f);

	MainRenderer->SetRootMotion("c1100_Lantern_Idle");
	MainRenderer->SetRootMotion("c1100_Lantern_Walk_Front");
	MainRenderer->SetRootMotionMoveRatio("c1100_Lantern_Walk_Front", 3.0f, 3.0f, 3.0f);
	MainRenderer->SetRootMotion("c1100_Lantern_Walk_Back");
	MainRenderer->SetRootMotionMoveRatio("c1100_Lantern_Walk_Back", 3.0f, 3.0f, 3.0f);
	MainRenderer->SetRootMotion("c1100_Lantern_Walk_Left");
	MainRenderer->SetRootMotionMoveRatio("c1100_Lantern_Walk_Left", 3.0f, 3.0f, 3.0f);
	MainRenderer->SetRootMotion("c1100_Lantern_Walk_Right");
	MainRenderer->SetRootMotionMoveRatio("c1100_Lantern_Walk_Right", 3.0f, 3.0f, 3.0f);
	MainRenderer->SetRootMotion("c1100_Lantern_Run");
	MainRenderer->SetRootMotionMoveRatio("c1100_Lantern_Run", 1.5f, 1.5f, 1.5f);
