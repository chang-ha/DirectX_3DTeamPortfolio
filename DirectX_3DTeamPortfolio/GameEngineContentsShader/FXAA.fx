...
{
    float4 CurColor = DiffuseTex.Sample(DiffuseTextureSampler, _Value.UV.xy);
    
    FxaaTex Tex;
    Tex.smpl = DiffuseTextureSampler;
    Tex.tex = DiffuseTex;
    
    float4 ResultColor = FxaaPixelShader(
    _Value.UV.xy,
    float4(0, 0, 0, 1),
    Tex,
    Tex,
    Tex,
    float2(1.0f / ScreenSize.x, 1.0f / ScreenSize.y),
    float4(-0.33f / ScreenSize.x, -0.33f / ScreenSize.y, 0.33f / ScreenSize.x, 0.33f / ScreenSize.y),
    float4(-2.0f / ScreenSize.x, -2.0f / ScreenSize.y, 2.0f / ScreenSize.x, 2.0f / ScreenSize.y),
    float4(8.0f / ScreenSize.x, 8.0f / ScreenSize.y, -4.0f / ScreenSize.x, -4.0f / ScreenSize.y),
    0.75f,
    0.125f,
    0.0625f,
    8.0f,
