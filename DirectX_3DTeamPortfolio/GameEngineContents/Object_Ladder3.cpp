...
void Object_Ladder3::Start()
{
	...
	Transform.SetWorldPosition({ -16460, 2440 , -3430 });
	...
	CollisionBottom->Transform.SetWorldPosition({ -16460, 2440 , -3430 });
	...
	CollisionTop->Transform.SetWorldPosition({ -16460, 2940 , -3430 });
