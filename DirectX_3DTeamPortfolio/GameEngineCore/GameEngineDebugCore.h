...
namespace GameEngineDebug
{
	...
	void DrawMesh(std::string_view _Mesh, float4 _Scale, float4 _Rot, float4 _Pos, float4 _Color = float4::RED, class GameEngineCamera* _Camera = nullptr);
	...
	class GameEngineDebugCore 
	{
		...
		// 함수도 friend걸수 있습니다.
		friend void GameEngineDebug::DrawMesh(std::string_view _Mesh, float4 _Scale, float4 _Rot, float4 _Pos, float4 _Color, class GameEngineCamera* _Camera);
